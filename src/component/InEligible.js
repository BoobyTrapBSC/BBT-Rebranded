  ...
  return (
    <div style={{width:"100%", height:"100vh"}}>
      <div style={{position:"absolute", top:"50%", left:"50%", transform:"translate(-50%, -50%)", textAlign:"center", padding:"25px 50px"}}>
        ...
        <a href='https://pancakeswap.finance/swap?outputCurrency=0x609b88f5a4aBB7A55bA0c6d255C3F1b1bC7A4D76' style={BBTBal <= BBTLimit? {display:"block"}:{display:"none"}}  target = "_blank" rel="noreferrer"><button className='getaccess btn button-blue px-2 mt-3'>GET ACCESS</button></a>
